...
var AudioBufferSource = class extends AudioSource {
	...
	*/
	async add(audioBuffer) {
		...
		for (const audioSample of iterator) await this._encoder.add(audioSample, true);
	}
	/** @internal */
	_flushAndClose(forceClose) {
		return this._encoder.flushAndClose(forceClose);
...
//#endregion
export { CanvasSource as a, canEncodeAudio as c, AudioBufferSource as i, canEncodeVideo as l, Mp4OutputFormat as n, BufferTarget as o, WebMOutputFormat as r, QUALITY_HIGH as s, Output as t };
